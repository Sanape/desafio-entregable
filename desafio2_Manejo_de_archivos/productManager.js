...
//Intento fallido de Test con assert

// // Llamo al metodo getProducts justo después de la instancia
// assert.deepEqual(
//   await productManager.getProducts(),
//   [],
//   'Failed on step 1: getProducts should return an empty array after initialization'
// );
...
//   'Failed on step 2: addProduct did not return the correct message'
// );
...
//     },
//   ],
//   'Failed on step 3: getProducts should return the new product.'
// );

// const addedProduct = await productManager.getProductById(1);

// assert.match(
//   addedProduct,
//   { ...testProduct, id: 1 },
//   'Failed on step 4: getProductById did not return the correct product.'
// );
...
//   await productManager.getProductById(1),
//   { ...update, id: 1 },
//   'Failed on step 5: updateProduct did not update the correct product.'
// );

// await productManager.deleteProduct(1);

// assert.deepEqual(
//   await productManager.getProducts().length,
//   0,
//   'Failed on step 6: deleteProduct did not delete the correct product.'
// );
